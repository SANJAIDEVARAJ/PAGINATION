...
// can change the number of rows to be displayed here
let rows = 10;
...
const y = list_items.map((i) => {
	return i.id+".    Name:" +i.name + ".    Email:" +i.email});
	
DisplayList(y, list_element, rows, current_page);
SetupPagination(y, pagination_element, rows);